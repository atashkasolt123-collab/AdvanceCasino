...
XROCKET_API_KEY = ""  # Удален xRocket
...
# --- Ссылки ---
CHANNEL_URL = "https://t.me/telegram"  # Ссылка на канал
SUPPORT_URL = "https://t.me/telegram"  # Ссылка на поддержку/помощь
SITE_URL = "https://example.com"       # Ссылка на сайт
CHAT_URL = "https://t.me/telegram"     # Ссылка на чат
ALERTS_CHANNEL = "@wins_alerts"        # Канал для крупных выигрышей/выводов
...
TEXTS = {
    "ru": {
        ...
        "privacy": (
            "<b>🥷 Приватность</b>\n\n"
            "— <i>Крупные ставки и победы в @AdvanceCasinoAlerts</i>\n"
    ...
    "en": {
        ...
        "privacy": (
            "<b>🥷 Privacy</b>\n\n"
            "— <i>Big bets and wins in @advancecasinoalerts</i>\n"
